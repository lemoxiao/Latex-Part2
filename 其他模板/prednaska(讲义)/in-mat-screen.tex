...
\topskip 0 pt plus 40 pt
 \newtheorem{vetapom}{\color{red}Vìta}[section]
...
\begin{document}
  ...
  \author{Robert Maøík\\
    \href{http://www.mendelu.cz}{MZLU v Brnì}\\
   ...
   \def\optionalpagematter{
     \begin{center}
       \colorbox{lightgray}{\begin{minipage}{0.75\hsize}\normalcolor
           Uèební text k mým pøedná¹kám z pøedmìtu In¾enýrská
           matematika.  Text je pomìrnì 
       hutný a není mínìn jako náhrada za doporuèenou literaturu. Je ¹íøen z~adresy
           \url{http://user.mendelu.cz/marik}, kde je dostupný ve
           formì vhodné pro tisk i ve formì vhodné pro prohlí¾ení na
           obrazovce a z~adresy \url{http://is.mendelu.cz/eknihovna/}, kde je ve formì elearningového kurzu.\\
...
Text obsahuje nìkolik interaktivních prvkù.

\begin{itemize}\item 
  V textu jsou takzvaná ``oslí okénka\ttp{ukazka}'' -- nìkteré
  dùle¾ité pojmy jsou doprovázeny modrými bublinami\footnote{Pokud se
    dané dùle¾ité slovo vyskytuje na stránce vícekrát, automatický
    mechanismus tvorbu nápovìdných bublin potlaèuje, tak aby ka¾dý
    pojem ke kterému je k dispozici nìjaká nápovìda, mìl tuto nápovìdu
    uvedenu jenom jednou -- a to pøednostnì ve vìtì èi v definici.},
  které jsou aktivní a po najetí na tyto bubliny se ètenáøi otevøe
  okénko pøipomínající definici, vyu¾ití a metodu výpoètu, které se
  týkají daného pojmu (vyzkou¹ejte si to na této stránce). Musíte
  pou¾ít komerèní Adobe Acrobat nebo volnì ¹iøitelný Adobe Reader,
  abyste tyto mo¾nosti mohli vyu¾ívat.
...
\item Takto vyznaèený odstavec obsahuje obzvlá¹» dùle¾itou informaci. \DUL{}
...
\vfill 
Tento uèební materiál byl vytvoøen s podporou grantu 99/2008 Fondu rozvoje vysokých ¹kol.
\newpage
...
\tlabelsep{3pt}
\mfpicunit=1pt
\chapter{Numerické øe¹ení diferencálních rovnic}
\input{numerika}
\closegraphsfile
