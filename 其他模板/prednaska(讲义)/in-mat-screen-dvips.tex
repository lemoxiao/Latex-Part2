...
\usepackage[%latextoc,
usetemplates,navibar,czech,dvips]{web}
...
\usepackage[dvips,filename=tooltipy,pages=37,movetips]{fancytooltips}
...
\def\ttpan#1{%
  ...
  \setbox0=\hbox{{\raisebox{0.3em}{\includegraphics[width=0.7em]%
        {fancytipmark.eps}}}}\hbox to 0 pt{\hskip -0.0em\copy0\hss}%
   ...
   \def\optionalpagematter{
     \begin{center}
       \colorbox{lightgray}{\begin{minipage}{0.75\hsize}\normalcolor
           ...
           matematika.  Text je ¹íøen z adresy
           \url{http://user.mendelu.cz/marik}, kde je dostupný ve
           formì vhodné pro tisk i ve formì vhodné pro prohlí¾ení na
           obrazovce z adresy \url{http://is.mendelu.cz/eknihovna/}, kde je ve formì elearningového kurzu.\\
